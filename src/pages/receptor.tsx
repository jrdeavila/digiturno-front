          ...
          <div className="flex flex-col" key={attentionProfile.id}>
            ...
            <div className="flex flex-col">
              {modules.filter(module => module.attentionProfileId === attentionProfile.id).map(
                module => (
                  <div key={module.id} className="flex flex-row items-center justify-start gap-x-1 pl-5">
                    ...
                    <CountIndicatorTarget>
                      {shifts.filter(shift => {
                        return shift.module === module.name && module.attentionProfileId === attentionProfile.id;
                      }).length}
                    </CountIndicatorTarget>
                  </div>
                )
